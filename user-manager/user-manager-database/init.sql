...
- are enabled
*/
DROP VIEW IF EXISTS public.v_filtered_users;
...
DROP VIEW IF EXISTS public.v_filtered_users_project;
...
INSERT INTO public.project(project_id, project_name, project_url) VALUES (1, 'Amazon', '{"gitlab": "gitlab.amazon.com/amazon/amazon.git"}');
INSERT INTO public.project(project_id, project_name, project_url) VALUES (2, 'Uber', '{"gitlab": "gitlab.uber.com/uber/uber.git"}');
INSERT INTO public.project(project_id, project_name, project_url) VALUES (3, 'Twitter', '{"sonarqube": "sonarqube.twitter.com/twitter/twitter.git", "gitlab": "gitlab.twitter.com/twitter/twitter.git"}');
INSERT INTO public.project(project_id, project_name, project_url) VALUES (4, 'Butterfly', '{"redmine": "redmine.dstackgroup.com/butterfly/butterfly.git", "gitlab": "gitlab.dstackgroup.com/butterfly/butterfly.git"}');
...
INSERT INTO public.x_user_contact(user_id, contact_type, contact_ref) VALUES (2, 'EMAIL', 'frispo');
